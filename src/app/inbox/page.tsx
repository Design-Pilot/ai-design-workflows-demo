...
import { profile, sidebarSections, filters, inboxEmails } from './inbox-data';
import { useThemeShortcut } from './use-theme-shortcut';
import styles from './inbox.module.css';

export default function InboxPage() {
  const [theme, setTheme] = useState<'light' | 'dark'>('light');
  const [activeNavId, setActiveNavId] = useState<string>('inbox');
